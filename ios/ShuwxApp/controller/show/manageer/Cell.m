...
- (void)resetModel:(CellModel *)data :(NSIndexPath *)indexPath {
    ...
    self.backgroundColor = data.backGroundColor;
     ...
     NSUserDefaults *defaults = [NSUserDefaults standardUserDefaults];
                ...
                NSString * imageUrl =  [Utils getPinjieNSString:pictureUrl:data.app_image];
    
    NSString  * defaultImage = @"appholder";
             [self.appImage sd_setImageWithURL:imageUrl placeholderImage:[UIImage imageNamed:defaultImage]];
