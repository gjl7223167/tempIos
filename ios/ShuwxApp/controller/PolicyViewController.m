...
@interface WeakWebViewScriptMessageFourDelegate : NSObject<WKScriptMessageHandler>
...
@implementation WeakWebViewScriptMessageFourDelegate
...
@interface PolicyViewController ()<WKScriptMessageHandler, WKUIDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"PolicyViewController"];
   
}
- (void)viewWillDisappear:(BOOL)animated{
[super viewWillDisappear:animated];
 [MobClick endLogPageView:@"PolicyViewController"];
}
...
- (void)viewDidLoad {
    ...
    [self setupNavigationItem];
      ...
      NSURLRequest *request = [NSURLRequest requestWithURL:[NSURL URLWithString:_htmlContent]];
...
//     cacheManager.whiteListsHost = @[@"39.98.225.237", @"github.com"];
//        //选择缓存方案
...
- (WKWebView *)webView{
    if(_webView == nil){
        ...
        WeakWebViewScriptMessageFourDelegate *weakScriptMessageDelegate = [[WeakWebViewScriptMessageFourDelegate alloc] initWithDelegate:self];
