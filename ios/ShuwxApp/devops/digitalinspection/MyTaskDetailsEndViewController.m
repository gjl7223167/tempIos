//
//  MyTaskDetailsEndViewController.m
//  ShuwxApp
//
...
#import "MyTaskDetailsEndViewController.h"
...
@interface MyTaskDetailsEndViewController ()

@end

@implementation MyTaskDetailsEndViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MyTaskDetailsEndViewController"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [MobClick endLogPageView:@"MyTaskDetailsEndViewController"];
...
- (void)initView{
    ...
    self.taskName.text = [self getIntegerValue:pointCount];
    self.taskNumber.text = plan_name;
      
       [self dataSource];
       [self.uitableView setSeparatorStyle:UITableViewCellSeparatorStyleNone];
      self.uitableView.showsVerticalScrollIndicator = NO;
       
       UINib *nib = [UINib nibWithNibName:@"MyTaskTableTwoHeaderView" bundle:nil];
       MyTaskTableTwoHeaderView *header = [nib instantiateWithOwner:nil options:nil][0];
...
-(void)setHeaderView:(MyTaskTableTwoHeaderView *)header{
...
{
//   static NSString *  MyTaskTableCellView = @"CellId";
//           //自定义cell类
//           MyTaskDetailsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:MyTaskTableCellView];
//           if (!cell) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.allView.layer.masksToBounds = YES;
       ...
       if (target_type_int == 1) {
           ...
           jjmbStr =   [self getPinjieNSString:jjmbStr:@""];
                    jjmbStr =   [self getPinjieNSString:jjmbStr:target_device_name];
             cell.jiancmb.text = jjmbStr;
