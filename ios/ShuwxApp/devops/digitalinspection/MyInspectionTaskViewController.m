//
//  MyInspectionTaskViewController.m
//  ShuwxApp
//
...
#import "MyInspectionTaskViewController.h"
...
@interface MyInspectionTaskViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentScrollView *pageContentScrollView;
@end

@implementation MyInspectionTaskViewController

-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"MyInspectionTaskViewController"];
...
- (void)viewWillDisappear:(BOOL)animated {
    ...
    [MobClick endLogPageView:@"MyInspectionTaskViewController"];
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:241/255.0 green:243/255.0 blue:255/255.0 alpha:1.0];
        self.navigationItem.title = @"我的巡检任务";
...
-(void)viewDidLayoutSubviews{
    ...
    self.pageTitleView.frame = CGRectMake(0, NAV_HEIGHT,SCREEN_WIDTH,  44);
    CGFloat ContentCollectionViewHeight = SCREEN_HEIGHT - CGRectGetMaxY(self.pageTitleView.frame);
    self.pageContentScrollView.frame = CGRectMake(0, CGRectGetMaxY(self.pageTitleView.frame),SCREEN_WIDTH,  ContentCollectionViewHeight);
}
...
- (void)setupSystem {
    ...
    MyTaskIngViewController * oneView = [[MyTaskIngViewController alloc] init];
              [self.childArr addObject:oneView];
    
    MyTaskEndViewController * Twoview = [[MyTaskEndViewController alloc] init];
