...
#import "MyTaskIngViewController.h"
...
@interface MyTaskIngViewController ()

@end

@implementation MyTaskIngViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MyTaskIngViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyTaskIngViewController"];
}
...
- (void)initView{
    ...
    [QTSub(self, MyEventBus) next:^(MyEventBus *event) {
        __strong typeof(self) strongSelf = weakSelf;
           ...
           if ([strongSelf getNSStringEqual:myErrorId:@"MyTaskIngViewController"]) {
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ( [self.dataSource count] <= 0) {
        return SCREEN_HEIGHT - NAV_HEIGHT - 44 - 60;
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        if ([self getKeyIsNoValueIsNull:dicOne:@"receiveTimeOut"]) {
            receiveTimeOut = [[dicOne objectForKey:@"receiveTimeOut"] intValue];
        }
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
   ...
   NSDictionary * dicOne  =   [self.dataSource objectAtIndex:indexPath.row];
        ...
        MyTaskDetailsViewController * alartDetail = [[MyTaskDetailsViewController alloc] init];
