//
//  LookSubmitThreeTableViewCell.m
//  ShuwxApp
//
...
@implementation LookSubmitThreeTableViewCell
...
-(void)initView{
    ...
    self.textView.layer.borderColor = [[UIColor colorWithRed:193.0/255.0 green:195.0/255.0 blue:255.0/225.0 alpha:1] CGColor];
...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated {
    ...
    // Configure the view for the selected state   UIScrollView
}
