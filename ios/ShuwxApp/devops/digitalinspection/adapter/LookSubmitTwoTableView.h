...
@interface LookSubmitTwoTableView : UITableViewCell<UICollectionViewDelegate, UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
    UINib *_personNib;
}
