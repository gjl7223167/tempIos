...
#import "ApprovalEndViewController.h"
#import "WRNavigationBar.h"
#import "AllWorkOrderTableViewCell.h"



@interface ApprovalEndViewController ()

@end

@implementation ApprovalEndViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"ApprovalEndViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"ApprovalEndViewController"];
}
