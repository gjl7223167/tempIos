...
#import "MainWorkEndViewController.h"
#import "WRNavigationBar.h"
#import "AllWorkOrderTableViewCell.h"



@interface MainWorkEndViewController ()

@end

@implementation MainWorkEndViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MainWorkEndViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MainWorkEndViewController"];
}
...
-(void)viewDidLayoutSubviews{
    [super viewDidLayoutSubviews];
       _uitableView.frame = CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT - NAV_HEIGHT -44);
}
    ...
    if (indexPath.section == 0) {
      ...
      NSDictionary * dicOne  =   [_dataSource objectAtIndex:indexPath.row];
       ...
       if (nil == receiveTimeOut || receiveTimeOut == [NSNull null]) {
        ...
        if (nil == start_set || start_set == [NSNull null]) {
                         start_set = @"0";
                     }
              ...
              int start_setInt = [start_set intValue];
...
-(void)getSelectReceiveOrderInfoByPage{
    ...
    [diction setValue:@(20) forKey:@"pageSize"];
     ...
     [diction setValue:@(4) forKey:@"table_value"];
