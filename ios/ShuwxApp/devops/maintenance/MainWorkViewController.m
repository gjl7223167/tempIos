...
#import "MainWorkViewController.h"
#import "WRNavigationBar.h"
#import "AllWorkOrderTableViewCell.h"



@interface MainWorkViewController ()

@end

@implementation MainWorkViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MainWorkViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MainWorkViewController"];
}
