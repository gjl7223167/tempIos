...
@interface MyApprovalViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MyApprovalViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyApprovalViewController"];
}
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:241/255.0 green:243/255.0 blue:255/255.0 alpha:1.0];
                  self.navigationItem.title = @"我的审批";
...
- (void)setupSystem {
    ...
    WaitApprovalIngViewController * oneView = [[WaitApprovalIngViewController alloc] init];
              [self.childArr addObject:oneView];
    
    ApprovalEndViewController * Twoview = [[ApprovalEndViewController alloc] init];
