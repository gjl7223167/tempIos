//
//  NoTimeOutOrderViewController.m
//  ShuwxApp
//
...
#import "NoTimeOutOrderViewController.h"
...
@interface NoTimeOutOrderViewController ()

@end

@implementation NoTimeOutOrderViewController
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"NoTimeOutOrderViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"NoTimeOutOrderViewController"];
}
...
- (void)initView{
    ...
    [QTSub(self, MyEventBus) next:^(MyEventBus *event) {
           ...
           if ([weakSelf getNSStringEqual:@"NoTimeOutOrderViewController":myErrorId]) {
                   [weakSelf clearData];
