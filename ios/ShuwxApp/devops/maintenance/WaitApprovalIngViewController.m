//
//  WaitApprovalIngViewController.m
//  ShuwxApp
//
...
#import "WaitApprovalIngViewController.h"
#import "WRNavigationBar.h"
#import "AllWorkOrderTableViewCell.h"



@interface WaitApprovalIngViewController ()

@end

@implementation WaitApprovalIngViewController
...
//    _uitableView.frame = CGRectMake(0,NAV_HEIGHT,SCREEN_WIDTH, SCREEN_HEIGHT - NAV_HEIGHT);
}
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MyOrderEngViewController"];
 //   [self getSelectMyJobLineInfoByPage];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyOrderEngViewController"];
}
...
-(void)getSelectReceiveOrderInfoByPage{
    ...
    [diction setValue:@(20) forKey:@"pageSize"];
     ...
     [diction setValue:@(1) forKey:@"table_value"];
 
    NSString * url = [self getPinjieNSString:baseUrl :selectMyMasOrderConfirmPageList];
