...
@interface MaintainOrderViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MaintainOrderViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MaintainOrderViewController"];
}
...
- (void)setupSystem {
    ...
    MainWorkViewController * oneView = [[MainWorkViewController alloc] init];
              [self.childArr addObject:oneView];
    
    WaitOrderViewController * Twoview = [[WaitOrderViewController alloc] init];
                 [self.childArr addObject:Twoview];
    
    OrderIngViewController * threeView = [[OrderIngViewController alloc] init];
      [self.childArr addObject:threeView];
    
    MainWorkEndViewController * fourView = [[MainWorkEndViewController alloc] init];
