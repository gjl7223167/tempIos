...
@interface MyReinforceViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentScrollView *pageContentScrollView;
@end

@implementation MyReinforceViewController

-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"MyReinforceViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyReinforceViewController"];
}
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:241/255.0 green:243/255.0 blue:255/255.0 alpha:1.0];
        self.navigationItem.title = @"我的增援";
...
- (void)setupSystem {
    ...
    MyReinforceIng * Twoview = [[MyReinforceIng alloc] init];
                 [self.childArr addObject:Twoview];
    
    MyReinforceEnd * threeView = [[MyReinforceEnd alloc] init];
