...
@interface MyCollaborationViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
@property (nonatomic, strong) SGPageTitleView *pageTitleView;
@property (nonatomic, strong) SGPageContentScrollView *pageContentScrollView;
@end

@implementation MyCollaborationViewController

-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"MyCollaborationViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyCollaborationViewController"];
}
...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor colorWithRed:241/255.0 green:243/255.0 blue:255/255.0 alpha:1.0];
        self.navigationItem.title = @"我的协同";
...
- (void)setupSystem {
    ...
    MyCollabViewController * Twoview = [[MyCollabViewController alloc] init];
                 [self.childArr addObject:Twoview];
    
    MyCollabEndViewController * threeView = [[MyCollabEndViewController alloc] init];
      [self.childArr addObject:threeView];
    
    TransferWorkViewController * fourView = [[TransferWorkViewController alloc] init];
