...
@interface MyOrdersViewController ()<SGPageTitleViewDelegate, SGPageContentScrollViewDelegate>
...
-(void)viewWillAppear:(BOOL)animated{
    ...
    [MobClick beginLogPageView:@"MyOrdersViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"MyOrdersViewController"];
}
...
- (void)setupSystem {
    ...
    MyordersIngViewController * Twoview = [[MyordersIngViewController alloc] init];
                 [self.childArr addObject:Twoview];
    
    MyordersEndViewController * threeView = [[MyordersEndViewController alloc] init];
