...
UIColor *MainNavBarColorTwo = nil;
UIColor *MainViewColorTwo = nil;
...
//                [self.navigationController pushViewController:allWorkOrder animated:YES];
            ...
            ReportDeviceViewController * allWorkOrder = [[ReportDeviceViewController alloc] init];
                      allWorkOrder.deviceuuid = deviceList;
                      allWorkOrder.devicetype = @"2";
                          [self.navigationController pushViewController:allWorkOrder animated:YES];
        }
...
//                        [self.navigationController pushViewController:allWorkOrder animated:YES];
            ...
            PositionDetailsViewController * allWorkOrder = [[PositionDetailsViewController alloc] init];
                                allWorkOrder.deviceuuid = deviceList;
             allWorkOrder.devicetype = @"3";
                                    [self.navigationController pushViewController:allWorkOrder animated:YES];
        }
