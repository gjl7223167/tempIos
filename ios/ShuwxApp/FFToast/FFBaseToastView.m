...
-(void)layoutToastView{
    ...
    switch (self.toastType) {
        case FFToastTypeDefault: {
            self.toastBackgroundColor = [UIColor colorWithRed:171/255.f green:72/255.f blue:74/255.f alpha:1.f];
            break;
        }
...
-(CGRect)toastViewFrame{
    ...
    return CGRectMake(toastViewX, toastViewY, toastViewW, toastViewH + 20);
}
...
-(void)layoutSubviews{
    ...
    self.messageLabel.frame = CGRectMake(messageLabelX, messageLabelY, SCREEN_WIDTH, messageLabelH);
