...
//            circleView.layer.borderColor = [LTSCalendarAppearance share].dayBorderColorToday.CGColor;
         ...
         NSMutableArray * array =      [LTSCalendarAppearance share].selectAllDate;
            
            if (array != nil && ![array isKindOfClass:[NSNull class]] && array.count != 0){
                if ([array containsObject:cacheCurrentDateText]) {
                    circleView.layer.borderColor = [LTSCalendarAppearance share].dayBorderColorToday.CGColor;
                }else{
                    circleView.layer.borderColor = [UIColor clearColor].CGColor;
                }
//                for (NSString * strItem in array) {
//                      if ([strItem isEqualToString:cacheCurrentDateText]) {
//                                      circleView.layer.borderColor = [LTSCalendarAppearance share].dayBorderColorToday.CGColor;
//                                 }else{
//                                     circleView.layer.borderColor = [UIColor clearColor].CGColor;
//                                 }
