...
#define SELECTED_COLOR [UIColor colorWithRed:0/255.0 green:255/255.0 blue:216/255.0 alpha:1.0]
#define UNSELECTED_COLOR [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]
#define TPOTABBOTTOMLINE_COLOR [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]
#define TOPSCROLLVIEW_COLOR [UIColor colorWithRed:98/255.0 green:119/255.0 blue:255/255.0 alpha:1.0]
...
-(void)isShowLocation:(BOOL)isShow{
    _isShowLocation = isShow;
}
...
- (instancetype)initWithFrame:(CGRect)frame withTitles:(NSArray *)titles withViewControllers:(NSArray *)controllers withParameters:(NSArray *)parameters{
    ...
    if (self) {
        ...
        _topScrollViewColor    = TOPSCROLLVIEW_COLOR;
...
- (UIScrollView *)topTabScrollView{
    if (!_topTabScrollView){
        ...
        _topTabScrollView.backgroundColor = _topScrollViewColor;
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView {
    ...
    if (self.clickTitleBlock) {
        self.clickTitleBlock(self.currentPage);
    }
}
...
- (void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context{
    if ([keyPath isEqualToString:@"currentPage"]) {
        NSInteger page = [change[@"new"] intValue];
...
//
//
//                if ([viewController isKindOfClass:[ReportParameterViewController class]]) {
//                    ReportParameterViewController * reportPara = viewController;
//                    reportPara.deviceId = _parameters[0];
//                    reportPara.deviceName = _parameters[1];
//                    reportPara.projectId = _parameters[2];
//                    [reportPara setRefresh];
//                }
//                if ([viewController isKindOfClass:[ReportRealTimeViewController class]]) {
//                    ReportRealTimeViewController * reportPara = viewController;
//                    reportPara.deviceId = _parameters[0];
//                    reportPara.deviceName = _parameters[1];
//                    reportPara.projectId = _parameters[2];
////                    [reportPara setRefresh];
