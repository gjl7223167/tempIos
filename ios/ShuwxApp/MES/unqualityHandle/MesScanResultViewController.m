//
//  MesScanResultViewController.m
//  ShuwxApp
//
//  Created by XuWei de apple on 2021/3/31.
...
@interface MesScanResultViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation MesScanResultViewController
...
//                           @"",@"status",
                           ...
                           nil];
    WS(weakSelf)
    [UrlRequest requestUnqualityScanWithParam:param completion:^(BOOL result, id  _Nonnull data, NSString * _Nonnull error) {
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    NSString *status = [self getStatusCode:[dic[@"status"] intValue]];
    if ([status isEqualToString:@"QOM_defective_product_disposal_02"]) {
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([status isEqualToString:@"QOM_defective_product_disposal_03"]) {
        return 216 - 40;
    }
    return 216;
}
