...
@implementation StoreRequireTableViewCell
...
+(instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    StoreRequireTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifer];
    if (nil == cell) {
...
- (void)setDataDic:(NSDictionary *)dataDic
{
    if (dataDic) {
        ...
        self.requireN.text = [NSString stringWithFormat:@"%@%@",dataDic[@"demandQty"],dataDic[@"unitName"]];
