//
//  QualityStandardViewController.m
//  ShuwxApp
//
...
@interface QualityStandardViewController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation QualityStandardViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self setNavi];
    self.showItems = [NSArray arrayWithObjects:@"检验项",@"结果类型",@"检验单位",@"上限值",@"下限值",@"标准值", nil];
    self.keys = [NSArray arrayWithObjects:@"name",@"typeName",@"unitsName",@"maxValue",@"minValue",@"standardValue", nil];
...
- (nonnull UITableViewCell *)tableView:(nonnull UITableView *)tableView cellForRowAtIndexPath:(nonnull NSIndexPath *)indexPath {
    ...
    cell.leftLabel.text = self.showItems[indexPath.row];
    NSString *key = self.keys[indexPath.row];
    cell.rightLabel.text = [Tools getString:dic[key]];
