...
@implementation SingleProductTableViewCell
...
+(instancetype)cellWithTableView:(UITableView *)tableView
{
    ...
    SingleProductTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifer];
    if (nil == cell) {
