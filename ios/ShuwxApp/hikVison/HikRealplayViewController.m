...
- (void)viewDidLoad {
	...
	// 实际开发中需要根据平台获取
	_realplayTextField.text = @"rtsp://123.157.208.28:10001/EUrl/Q4gq5YQd";
...
- (void)configureSubviews {
    ...
    self.playView.frame = CGRectMake(0, SafeAreaTopHeight, SCREEN_WIDTH, 250);
    ...
    self.indicatorView.frame = CGRectMake(SCREEN_WIDTH/2 - kIndicatorViewSize/2, SafeAreaTopHeight + 125 - kIndicatorViewSize/2, kIndicatorViewSize, kIndicatorViewSize);
