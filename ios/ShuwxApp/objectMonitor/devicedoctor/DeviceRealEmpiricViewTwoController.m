//
//  DeviceRealEmpiricViewTwoController.m
//  ShuwxApp
//
...
#import "DeviceRealEmpiricViewTwoController.h"
...
@interface DeviceRealEmpiricViewTwoController ()<XLHTableViewDelegate>
...
@implementation DeviceRealEmpiricViewTwoController


-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"DeviceRealEmpiricViewTwoController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"DeviceRealEmpiricViewTwoController"];
}
...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[HisjyTableViewCell class] forCellReuseIdentifier:DeviceRealView];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        //自定义cell类
        HisjyTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:DeviceRealView];
        
        if (!cell){
            cell = [[HisjyTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:DeviceRealView];
        }
        
        cell.delegate = self;
        [cell setModel:self.dataSource[indexPath.row]];
        [cell setValues:self.dataSource[indexPath.row]];
...
-(void)setLabelViews:(NSMutableDictionary *)nsArr{
    ...
    if (self.labelThree == nil) {
        ...
        labelThreeName.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelFour == nil) {
        ...
        labelFourName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelFour.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelFive == nil) {
        ...
        labelFiveName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelFive.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelSix == nil) {
        ...
        labelSixName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelSix.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelEight == nil) {
        ...
        labelEightName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelEight.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelEleven == nil) {
        ...
        labelElevenName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelEleven.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelTwelve == nil) {
        ...
        labelTwelveName.font = [UIFont systemFontOfSize:12];
        ...
        self.labelTwelve.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelThirteen == nil) {
        ...
        labelThirteenName.font = [UIFont systemFontOfSize:12];
        ...
        //   [self.labelTwelve sizeToFit];
        self.labelThirteen.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelFourteen == nil) {
        ...
        labelFourteenName.font = [UIFont systemFontOfSize:12];
        ...
        //   [self.labelTwelve sizeToFit];
        self.labelFourteen.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelFifteen == nil) {
        ...
        labelFifteeneName.font = [UIFont systemFontOfSize:12];
        ...
        //   [self.labelTwelve sizeToFit];
        self.labelFifteen.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelSixteen == nil) {
        ...
        labelSixteenName.font = [UIFont systemFontOfSize:12];
        ...
        //   [self.labelTwelve sizeToFit];
        self.labelSixteen.font = [UIFont systemFontOfSize:12];
    ...
    if (self.labelTen == nil) {
        ...
        self.labelTen.font = [UIFont systemFontOfSize:14];
