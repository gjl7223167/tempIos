//
//  KeepRepairListViewController.m
//  ShuwxApp
//
...
#import "KeepRepairListViewController.h"
#import "QTEventBus.h"
#import "MyEventBus.h"
...
@interface KeepRepairListViewController ()

@end

@implementation KeepRepairListViewController

-(void)viewWillAppear:(BOOL)animated{
    [super viewWillAppear:animated];
    [MobClick beginLogPageView:@"KeepRepairListViewController"];
}

- (void)viewWillDisappear:(BOOL)animated {
    [super viewWillDisappear:animated];
    [MobClick endLogPageView:@"KeepRepairListViewController"];
}
    ...
    if (indexPath.section == 0) {
       ...
       NSDictionary * dicOne  =   [self.dataSource objectAtIndex:indexPath.row];
              NSString * order_code =  [dicOne objectForKey:@"order_code"];
               NSString * receive_time =  [dicOne objectForKey:@"receive_time"];
              ...
              cell.oneName.text = @"维修时间";
               cell.twoName.text = @"维修人员";
              cell.threeName.text = @"维修内容";
              
              cell.oneNameValue.text = receive_time;
                cell.twoNameValue.text = receive_man_name;
        
      cell.threeNameValue.text = content;
...
//    [diction setValue:module_type_doctor forKey:@"module_type"];
    ...
    NSString * url = [self getPinjieNSString:baseUrl :selectFixOrderInfoByObjectId];
