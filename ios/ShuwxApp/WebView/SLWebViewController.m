...
- (void)setupNavigationItem{
    ...
    goBackButton.frame = CGRectMake(0, 0, 30, NAV_HEIGHT);
    ...
    refreshButton.frame = CGRectMake(0, 0, 30, NAV_HEIGHT);
    ...
    SLWebCacheManager *cacheManager = [SLWebCacheManager shareInstance];
     cacheManager.whiteListsHost = @[@"www.baidu.com", @"github.com", @"www.jianshu.com", @"juejin.im",@"www.jiagtong.com"];
        //选择缓存方案
...
- (UIProgressView *)progressView {
    if (!_progressView){
        _progressView = [[UIProgressView alloc] initWithFrame:CGRectMake(0, NAV_HEIGHT + 2, self.view.frame.size.width, 2)];
...
//        [_webView loadHTMLString:htmlString baseURL:[NSURL fileURLWithPath:[[NSBundle mainBundle] bundlePath]]];
        ...
        NSString *        htmlString = @"http://www.jiagtong.com/";
